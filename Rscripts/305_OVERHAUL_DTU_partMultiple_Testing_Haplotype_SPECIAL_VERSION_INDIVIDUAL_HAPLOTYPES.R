      ...
      for(k in 1:length(Proxy_array))
      {
        ...
        if(length(FLAG) >0)
        {
          ...
          if (file.exists(path10)){
            ...
            filename_rds_haplotype<-paste("DTU_LogLM_Haplotypes_RESULTS_NOMINAL_",paste(SELECTED_VARS_UPDATED_sel,Proxy_array_sel, sep="__"),'.rds', sep='')
                ...
                if(length(ENSG_array) >0)
                {
                  ...
                  if(dim(Results_Nominal_sel)[1] >0)
                  {
                    ...
                    for(l in 1:length(array_comparisons))
                    {
                      ...
                      indx.select<-c(which(colnames(Results_Nominal_sel_comparison_sel)== "ensembl_gene_id"),which(colnames(Results_Nominal_sel_comparison_sel)== "HGNC"),which(colnames(Results_Nominal_sel_comparison_sel)== "transcript_id"),
                                     which(colnames(Results_Nominal_sel_comparison_sel)== "comparison"),
                    ...
                    if(length(list_comparisons) >0)
                    {
                      ...
                      DTU_CIS_gene<-Results_corrected_all_comparisons[which(Results_corrected_all_comparisons$ajusted.minuslogpvalue_Haplotypes_specific_CELL_COUNTS >= 1.3),]
                      ...
                      {
                        saveRDS(file="DTU_CIS_gene.rds", Results_corrected_all_comparisons)  
                      }
              ...
              if(dim(ALL_FINAL_sel)[1] >0)
              {
                ...
                if(length(ENSG_array) >0)
                {
                  ...
                  { 
                    ...
                    cat(str(Results_Nominal_sel))
                    cat("\n")
                    cat(str(unique(Results_Nominal_sel$ensembl_gene_id)))
                    cat("\n")
                    cat(sprintf(as.character(names(summary(as.factor(Results_Nominal_sel$comparison))))))
                    cat("\n")
                    cat(sprintf(as.character(summary(as.factor(Results_Nominal_sel$comparison)))))
                  ...
                  if(dim(Results_Nominal_sel)[1] >0)
                  {
                    ...
                    if(length(list_comparisons) >0)
                    {
                      ...
                      DTU_Block<-Results_corrected_all_comparisons[which(Results_corrected_all_comparisons$ajusted.minuslogpvalue_Haplotypes_specific_CELL_COUNTS >= 1.3),]
                      ...
                      if(dim(Results_corrected_all_comparisons)[1] >0)
                      {
                        saveRDS(file="DTU_Block.rds", Results_corrected_all_comparisons)  
                      }
                    }#length(list_comparisons) >0
                  }#dim(Results_Nominal_sel)[1] >0
                }#length(ENSG_array) >0
          ...
          if (file.exists(path10)){
            ...
            if (file.exists(filename_rds_haplotype)){
              ...
              for(l in 1:length(array_comparisons))
              {
                ...
                indx.select<-c(which(colnames(Results_Nominal_comparison_sel)== "ensembl_gene_id"),which(colnames(Results_Nominal_comparison_sel)== "HGNC"),which(colnames(Results_Nominal_comparison_sel)== "transcript_id"),
                               which(colnames(Results_Nominal_comparison_sel)== "comparison"),
              ...
              if(length(list_comparisons) >0)
              {
                ...
                DTU_genome_wide<-Results_corrected_all_comparisons[which(Results_corrected_all_comparisons$ajusted.minuslogpvalue_Haplotypes_specific_CELL_COUNTS >= 1.3),]
                ...
                if(dim(Results_corrected_all_comparisons)[1] >0)
                {
                  saveRDS(file="DTU_genome_wide.rds", Results_corrected_all_comparisons)  
                }
              }#length(list_comparisons) >0
            }else{
